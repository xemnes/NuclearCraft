...
public abstract class MultiblockBlockPartTrapdoor extends NCBlockTrapDoor implements ITileEntityProvider {

    public MultiblockBlockPartTrapdoor(Material material) {
        super(material);
        hasTileEntity = true;
