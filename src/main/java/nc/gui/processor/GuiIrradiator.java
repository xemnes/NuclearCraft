...
public class GuiIrradiator extends GuiFluidProcessor {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		drawTexturedModalRect(32, 35, 176, 41, 16, 16);
		drawTexturedModalRect(52, 35, 176, 41, 16, 16);
		drawTexturedModalRect(108, 31, 176, 57, 24, 24);
		drawTexturedModalRect(136, 31, 176, 57, 24, 24);
