...
public class GuiCentrifuge extends GuiFluidProcessor {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		drawTexturedModalRect(50, 41, 176, 41, 16, 16);
		drawTexturedModalRect(106, 31, 176, 41, 16, 16);
		drawTexturedModalRect(126, 31, 176, 41, 16, 16);
		drawTexturedModalRect(106, 51, 176, 41, 16, 16);
		drawTexturedModalRect(126, 51, 176, 41, 16, 16);
